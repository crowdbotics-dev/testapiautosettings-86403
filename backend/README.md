...
## Project Structure
    ...
    ├── testapiautosettings_86403  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_86403`
...
2. Clone this repo and `cd testapiautosettings_86403`
